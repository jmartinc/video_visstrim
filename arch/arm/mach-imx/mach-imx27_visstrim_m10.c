...
/* DMA interlace */
static struct platform_device visstrim_m10_deinterlace = {
	.name = "m2m-deinterlace",
	.id = 0,
};

static void __init visstrim_m10_deinterlace_init(void)
{
	int ret = -ENOMEM;
	struct platform_device *pdev = &visstrim_m10_deinterlace;
	int dma;
